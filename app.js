...
sschedButton.addEventListener("click", showSched);
...
// MediaQuery-Based Show Schedule Button Functionality

async function showSched() {
    if (MediaQuery.matches) {
        schedCont.classList.toggle("hidden");
        schedCont.style.zIndex = "999";
        schedCont.children[0].style.width = "80dvw"
    } else {
...
function mediaChange() {
    if (MediaQuery.matches) {
        sschedButton.children[0].innerHTML = "👁";
    } else {
        sschedButton.children[0].innerHTML = "<";
    }
};
